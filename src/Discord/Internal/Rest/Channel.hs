...
data ChannelRequest a where
  ...
  CreateMessageEmbed      :: ChannelId -> T.Text -> OldEmbed -> ChannelRequest Message
  ...
  EditMessage             :: (ChannelId, MessageId) -> T.Text -> Maybe OldEmbed
...
maybeEmbed :: Maybe OldEmbed -> [(T.Text, Value)]
